...
Plywood comes bundled with many [higher-level C++ libraries](/docs/high-level.md), including a full [AI agent harness](/docs/agent-harness.md), providing an easy way to add agentic AI capabilities to existing C++ programs.
