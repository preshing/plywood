...
Plywood comes bundled with several [higher-level C++ libraries](/docs/high-level.md), including a complete [agent harness](/docs/high-level/agent-harness.md), providing an easy way to add agentic AI capabilities to existing C++ programs.
