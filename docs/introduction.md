...
Plywood comes bundled with several [higher-level C++ libraries](/docs/high-level.md), including an [agent harness](/docs/high-level/agent-harness.md) library, providing an easy way to add agentic AI capabilities to existing C++ programs.
