...
if(MSVC)
    ...
    set(CMAKE_C_FLAGS_DEBUG "/D_DEBUG /DPLY_WITH_ASSERTS=1 /MDd /ZI /Od /Ob0 /RTC1")
    set(CMAKE_C_FLAGS_RELEASE "/DNDEBUG /DPLY_WITH_ASSERTS=1 /MD /Zi /O2 /Ob1 /Oi")
    set(CMAKE_C_FLAGS_FINAL "/DNDEBUG /MD /Zi /O2 /Ob1 /Oi")
else()
...
function(add_curl)
    ...
    elseif(UNIX)
        ...
        target_link_libraries(curl INTERFACE ${CURL_LIB} OpenSSL::SSL OpenSSL::Crypto)
    endif()
endfunction()
